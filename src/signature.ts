...
export const ecsign = function(
  ...
  const sig = secp256k1.ecdsaSign(new Uint8Array(msgHash), new Uint8Array(privateKey))
...
export const ecrecover = function(
  ...
  const senderPubKey = secp256k1.ecdsaRecover(new Uint8Array(signature), recovery, new Uint8Array(msgHash))
